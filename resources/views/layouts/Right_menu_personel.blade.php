...
<div class="container-fluid side-bar-container ">
    <header class="pb-0 logo">
        ...
        <p class="side-comment  fnt-mxs">پرسنل فروش</p>
        <li class="side a-collapse short m-2 pr-1 pl-1">
            <a href="/personnel" class="side-item selected c-dark ">
        ...
        <li class="side a-collapse short ">
            <a href="{{ route('user.children', ['id' => auth()->user()->id]) }}" class="side-item "><i class="fas fa-icons  mr-1"></i>نماینده های من</a>
        </li>
        ...
        <ul class="side a-collapse short">
            ...
            <div class="side-item-container hide animated">
                <li class="side-item"><a href="{{ route('requests.personeelindex') }}" class="fnt-mxs"><i class="fas fa-angle-right mr-2"></i>مدیریت درخواست ها</a></li>
                ...
                <li class="side-item"><a href="{{ route('dis_requests.personelcompleted') }}" class="fnt-mxs"><i class="fas fa-angle-right mr-2"></i> درخواست های حواله دار</a></li>
        ...
        <!-- <ul class="side a-collapse short">
            <a class="ul-text  fnt-mxs"><i class="fas fa-cog mr-1"></i> بازاریابی و فروش
                <i class="fas fas fa-chevron-down arrow"></i></a>
            <div class="side-item-container hide animated">
                <li class="side-item"><a href="./color.html" class="fnt-mxs"><i class="fas fa-angle-right mr-2"></i>ثبت سر نخ جدید</a></li>
                <li class="side-item"><a href="./typo.html" class="fnt-mxs"><i class="fas fa-angle-right mr-2"></i>مشاهده تمام سرنخ ها</a></li>
