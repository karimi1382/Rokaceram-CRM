                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th>درخواست‌های بارگیری شده (متر)</th>
                            <th>تارگت ماه (متر)</th>
                    ...
                    <tbody>
                        @if ($userDetails->isEmpty())
                            <tr>
                                <td colspan="10" class="text-center">هیچ داده‌ای یافت نشد.</td>
                            </tr>
                        @else
                            <?php $n = 0; ?>
                            @foreach ($userDetails as $user)
                                ...
                                <tr>
                                    ...
                                    <td>{{ $user['approved_request_size'] ?? 0 }} متر</td>
                                    <td>{{ $user['completed_request_size'] ?? 0 }} متر</td>
                                    <td>{{ $user['target'] ?? 0 }} متر</td>
                                    <td>{{ number_format($user['completed_year_total'] ?? 0, 2) }} متر</td>
